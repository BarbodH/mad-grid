 ...
 *                      - correct solution is marked on the boxes in order to guide the user
    ...
    private void switchDescriptionColors(View rootView, int delay, int delayInitial) {
        // initialization
        TextView watchDescription = (TextView) rootView.findViewById(R.id.guide_fragment_classic_text_button_inactive_description);
        TextView replicateDescription = (TextView) rootView.findViewById(R.id.guide_fragment_classic_text_button_active_description);
